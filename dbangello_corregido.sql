-- ================================================================
-- BASE DE DATOS DBANGELLO - VERSION CORREGIDA
-- ================================================================
...
-- PEDIDOS (DELIVERY) - CORREGIDA LA REFERENCIA A USUARIOS
CREATE TABLE Pedido (
...
('Juan Pérez','juan.p@ejemplo.com','pbkdf2:sha256:600000$randomsalt123$hashedpassword123'),
('Ana López','ana.l@ejemplo.com','pbkdf2:sha256:600000$randomsalt456$hashedpassword456'),
('Luis Ramos','luis.r@ejemplo.com','pbkdf2:sha256:600000$randomsalt789$hashedpassword789'),
('Pedro Castro','pedro.c@ejemplo.com','pbkdf2:sha256:600000$randomsalt101$hashedpassword101'),
('Marco Vega','marco.v@ejemplo.com','pbkdf2:sha256:600000$randomsalt102$hashedpassword102');
...
(1,'Av Lima 123',1,60.00,'Pagado'),
(2,'Jr Arequipa 456',2,45.00,'Pendiente'),
(3,'Calle Sol 789',3,30.00,'Pagado');

-- DETALLES DE PEDIDOS (USANDO IDS REALES DE PRODUCTOS)
INSERT INTO PedidoDetalle(idPedido,idProducto,cantidad,precioUnitario) VALUES
(1,1,2,20.00),  -- 2x 1/4 Pollo a la Leña
(1,25,1,20.00), -- 1x Porción de Papas
(2,5,1,24.00),  -- 1x Pizza Margarita  
(2,31,1,7.00),  -- 1x Gaseosa Gordita
(3,20,1,25.00), -- 1x Ravioles Jamón/Queso
(3,33,1,5.00);  -- 1x Café Solo
...
-- Vista de carrito por usuario
CREATE OR REPLACE VIEW vw_carrito_usuario AS
SELECT
    c.idCarrito,
    c.idUsuario,
    c.fecha,
